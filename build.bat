...
set static_include=/I"D:/work/noname/external/glfw-3.3.9/include" 
set external_include=/I"..\external\opengl"

set linker_flags=user32.lib gdi32.lib Shell32.lib opengl32.lib "D:/work/noname/external/glfw-3.3.9/lib/glfw3.lib"
