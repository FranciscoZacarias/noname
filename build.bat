...
set external_include=/I"..\src\external\opengl" /I"..\src/external/glfw-3.3.9/include" /I"../src/fbase"
set linker_flags=user32.lib gdi32.lib Shell32.lib opengl32.lib "..\src/external/glfw-3.3.9/lib/glfw3.lib"
